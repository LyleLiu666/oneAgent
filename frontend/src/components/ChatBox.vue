...
const buildAssistantErrorContent = (
  parsed: ParsedApiError | null | undefined,
  fallback: string,
) => {
...
const buildInlineStreamErrorSuffix = (
  parsed: ParsedApiError | null | undefined,
  fallback: string,
) => {
...
const appendAssistantErrorMessage = (
  parsed: ParsedApiError | null | undefined,
  fallback: string,
) => {
    ...
    await attachChatStream(
      ...
      (error) => {
        ...
        if (idx >= 0) {
          ...
          msg.content =
            (msg.content || "") +
            buildInlineStreamErrorSuffix(parsed, "恢复会话流失败");
          msg.isStreaming = false;
        } else if (!sawMsgEvents) {
    ...
    await streamChat(
      ...
      (error) => {
        ...
        if (idx >= 0) {
          ...
          msg.content =
            (msg.content || "") +
            buildInlineStreamErrorSuffix(parsed, "发送失败");
          msg.isStreaming = false;
        } else if (!sawMsgEvents) {
    ...
    >
          ...
          <div class="flex items-center gap-2 flex-wrap justify-end">
            ...
            <template v-if="!isSecretaryMode">
              ...
              <p
                ...
                data-testid="chat-workspace-chooser-hint"
      ...
      <div class="p-4 shrink-0">
        <div class="max-w-4xl mx-auto">
          ...
          >
            <ErrorBanner
              :error="chatModelSetupError"
              :title="chatModelSetupTitle"
            />
