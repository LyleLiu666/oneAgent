## 1. Implementation
- [ ] 1.1 Add spec deltas for actionable skill.read not-found + skills help TurnContext
- [ ] 1.2 Backend: improve `skill.read` not-found response (normalized id, suggestions<=5, next steps)
- [ ] 1.3 Backend tests: add unit test for not-found + suggestions behavior
