## 1. Implementation
- [ ] 1.1 Add spec deltas for `.oneagent/project.json` and attempt script lifecycle
...
- [ ] 1.7 Run `openspec validate add-project-scripts --strict --no-interactive` and keep tests green
